const mailVerify = (randStr, email, url) => {
    return `<!DOCTYPE html>
<html>
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <h1
                                ...
                                Thank you for registering for BK-Chat</h1>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">We need to verify your email address to complete your registration
                            process. Let us know it's you by clicking the button below.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                    <a href="${url}/auth/verify?email=${email}&token=${randStr}" target="_blank"
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">If that doesn't work, copy and paste the following link in your
                                browser:</p>
                            <p style="margin: 0;"><a href="${url}/auth/verify?email=${email}&token=${randStr}" target="_blank">${url}/auth/verify?email=${email}&token=${randStr}</a>
                            </p>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">
                                ...
                                verify for your account. If you didn't request verify you can safely
                                delete this email.
                            </p>
                        </td>
                    </tr>
